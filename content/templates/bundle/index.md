...
tags: ["bundle", "ASC 842", "ASC 606", "fixed assets", "SaaS metrics", "runway", "Excel template"]
faq:
  ...
  - q: "Can I buy one now and upgrade to the bundle later?"
    a: "Yes. Email hello@kdeskaccounting.com with your Gumroad receipt and you'll get a bundle link credited for what you already paid."
...
The month-end close checklist's reconciliation tab has a row for deferred commissions, a row for lease liabilities, a row for accumulated depreciation. Each of those rows ties to a schedule — and each schedule is one of the workbooks in this bundle. Buy them together and the JE tracker's source dropdown, the reconciliation rows, and the technical schedules all name the same files.
...
- Controllers and accounting managers at Series A–C SaaS companies running technical accounting in Excel
- Fractional CFOs and outsourced accounting firms who need one standard toolkit across clients
- Finance leads preparing for a first audit who need defensible schedules, not a $20k software contract

## What It Is Not

The workbooks are standalone Excel files with capacity limits (20 leases, 50 deals, 50 assets). If you are past those, purpose-built software is the right tool. There is no cloud sync, no API, no subscription.
...
**Can I buy one now and upgrade to the bundle later?**
Yes. Email hello@kdeskaccounting.com with your Gumroad receipt and you'll get a bundle link credited for what you already paid.

**Does it work on a Mac?**
Yes. Every workbook is pure Excel formulas — no VBA macros, no Windows-only features. Excel 2016, Excel 365, and Excel for Mac.
